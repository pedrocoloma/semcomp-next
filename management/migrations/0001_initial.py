...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'management_attendance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.SemcompUser'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Event'])),
        ))
        db.send_create_signal(u'management', ['Attendance'])


    def backwards(self, orm):
        # Deleting model 'Attendance'
        db.delete_table(u'management_attendance')
    ...
    models = {
        ...
        u'management.attendance': {
            'Meta': {'object_name': 'Attendance'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['website.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

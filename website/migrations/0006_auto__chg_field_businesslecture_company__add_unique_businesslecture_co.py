...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BusinessLecture.company'
        db.alter_column(u'website_businesslecture', 'company_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['website.Company'], unique=True, null=True, on_delete=models.SET_NULL))
        # Adding unique constraint on 'BusinessLecture', fields ['company']
        db.create_unique(u'website_businesslecture', ['company_id'])


        # Changing field 'RecruitmentProcess.company'
        db.alter_column(u'website_recruitmentprocess', 'company_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['website.Company'], unique=True, null=True, on_delete=models.SET_NULL))
        # Adding unique constraint on 'RecruitmentProcess', fields ['company']
        db.create_unique(u'website_recruitmentprocess', ['company_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RecruitmentProcess', fields ['company']
        db.delete_unique(u'website_recruitmentprocess', ['company_id'])

        # Removing unique constraint on 'BusinessLecture', fields ['company']
        db.delete_unique(u'website_businesslecture', ['company_id'])


        # Changing field 'BusinessLecture.company'
        db.alter_column(u'website_businesslecture', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Company'], null=True, on_delete=models.SET_NULL))

        # Changing field 'RecruitmentProcess.company'
        db.alter_column(u'website_recruitmentprocess', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Company'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'website.businesslecture': {
            ...
            'company': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['website.Company']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inscricao.numero_documento'
        db.add_column(u'website_inscricao', 'numero_documento',
                      self.gf('django.db.models.fields.CharField')(max_length='30', unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inscricao.numero_documento'
        db.delete_column(u'website_inscricao', 'numero_documento')
    ...
    models = {
        ...
        u'website.inscricao': {
            ...
            'numero_documento': ('django.db.models.fields.CharField', [], {'max_length': "'30'", 'unique': 'True', 'null': 'True', 'blank': 'True'}),

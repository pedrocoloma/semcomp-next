...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.in_fair'
        db.add_column(u'website_company', 'in_fair',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.in_fair'
        db.delete_column(u'website_company', 'in_fair')
    ...
    models = {
        ...
        u'website.businesslecture': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['website.Company']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SemcompConfig', fields ['name']
        db.create_unique(u'website_semcompconfig', ['name'])

        # Adding unique constraint on 'SemcompConfig', fields ['title']
        db.create_unique(u'website_semcompconfig', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'SemcompConfig', fields ['title']
        db.delete_unique(u'website_semcompconfig', ['title'])

        # Removing unique constraint on 'SemcompConfig', fields ['name']
        db.delete_unique(u'website_semcompconfig', ['name'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.used_for_attendance'
        db.add_column(u'website_event', 'used_for_attendance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.used_for_attendance'
        db.delete_column(u'website_event', 'used_for_attendance')

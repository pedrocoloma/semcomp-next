...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Column.custom_classes'
        db.add_column(u'cmsplugin_column', 'custom_classes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Column.custom_classes'
        db.delete_column(u'cmsplugin_column', 'custom_classes')

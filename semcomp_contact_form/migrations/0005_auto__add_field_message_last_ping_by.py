...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.last_ping_by'
        db.add_column(u'semcomp_contact_form_message', 'last_ping_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['website.SemcompUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.last_ping_by'
        db.delete_column(u'semcomp_contact_form_message', 'last_ping_by_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'semcomp_contact_form_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('last_ping', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1999, 12, 31, 0, 0))),
            ('last_ping_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['website.SemcompUser'])),
            ('in_reply_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='replies', null=True, to=orm['semcomp_contact_form.Message'])),
            ('to_email', self.gf('django.db.models.fields.EmailField')(max_length=254)),
            ('to_course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.Course'], null=True, on_delete=models.SET_NULL)),
            ('sent_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='replied_messages', null=True, on_delete=models.SET_NULL, to=orm['website.SemcompUser'])),
            ('is_announcement', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('from_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('from_email', self.gf('django.db.models.fields.EmailField')(max_length=254)),
        ...
        db.send_create_signal(u'semcomp_contact_form', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table(u'semcomp_contact_form_message')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.is_announcement'
        db.add_column(u'semcomp_contact_form_message', 'is_announcement',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.is_announcement'
        db.delete_column(u'semcomp_contact_form_message', 'is_announcement')

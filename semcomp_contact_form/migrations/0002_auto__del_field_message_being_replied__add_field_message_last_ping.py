...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.being_replied'
        db.delete_column(u'semcomp_contact_form_message', 'being_replied')

        # Adding field 'Message.last_ping'
        db.add_column(u'semcomp_contact_form_message', 'last_ping',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1999, 12, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.being_replied'
        db.add_column(u'semcomp_contact_form_message', 'being_replied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Message.last_ping'
        db.delete_column(u'semcomp_contact_form_message', 'last_ping')

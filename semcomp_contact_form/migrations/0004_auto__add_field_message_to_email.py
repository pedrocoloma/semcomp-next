...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.to_email'
        db.add_column(u'semcomp_contact_form_message', 'to_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.to_email'
        db.delete_column(u'semcomp_contact_form_message', 'to_email')
